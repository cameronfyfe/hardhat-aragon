...
function parseContractFunctions(sourceCode, targetContract, options) {
    ...
    if (ast.type !== 'SourceUnit')
        throw new errors_1.AragonPluginError('First block is not of expected type SourceUnit');
    ...
    const notices = (0, parseFunctionNotices_1.parseFunctionsNotices)(sourceCode);
    const noticesBySignature = (0, lodash_1.keyBy)(notices, (n) => n.signature);
