...
function getPrettyPublishTxPreview({ txData, appName, nextVersion, bump, contractAddress, contentHash, ipfsGateway, }) {
    ...
    switch (txData.methodName) {
        ...
        case 'newVersion':
            ...
            break;
        default:
            throw new errors_1.AragonPluginError(`Unknown txData methodName ${txData.methodName}`);
    }
...
${list.print(2)}
  ...
  ${chalk_1.default.cyan((0, url_1.urlJoin)(ipfsGateway, 'ipfs', contentHash))}
`;
}
...
exports.getPublishTxOutput = {
    dryRun: ({ txData, rootAccount, }) => {
        ...
        list.addData('data', (0, apm_1.encodePublishVersionTxData)(txData));
        return `
...
${list.print(2)}
  ${etherscanUrl
            ? `
  ${chalk_1.default.cyan((0, url_1.urlJoin)(etherscanUrl, 'tx', txHash))}
  `
            : ''}`;
    },
    /**
